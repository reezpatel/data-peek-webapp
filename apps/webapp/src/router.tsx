...
// useAutoUpdater removed — not applicable in web
...
// TitlebarActions removed — not applicable in web
...
function LayoutContent() {
  ...
  const platform = window.electron?.process?.platform || 'browser'
...
function RootLayout() {
  // Auto-updater removed — not applicable in web
...
// Create router (using default browser history for web)
